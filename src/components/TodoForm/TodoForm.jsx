...
import { Title, FormBox, Label, Input, ErrorText, SaveButton, CancelButton } from './TodoForm.styled';

const schema = Yup.object({
  id: Yup.string(),
  name: Yup.string().max(30, 'Name cannot exceed more than 30 characters').required('Required'),
  description: Yup.string().max(150, 'Description cannot exceed more than 150 characters').required('Required'),
...
export const TodoForm = () => {
  ...
  const initialValues = {
    ...
    createdDate: modalTodoData?.createdDate || moment().format("DD-MMM-YYYY HH:mm"),
    ...
    <>
      ...
      <Formik initialValues={initialValues} validationSchema={schema} onSubmit={handleSubmit}>
        <FormBox>
          ...
          <FormError name="description"></FormError>
