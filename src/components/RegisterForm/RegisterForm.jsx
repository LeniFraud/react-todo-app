...
import {  Container, Link, FormBox, Label, Input, ErrorText, Button } from './RegisterForm.styled';
...
const schema = Yup.object({
  ...
  .required('Required'),
  confirmedPassword: Yup.string().oneOf([Yup.ref('password')], 'Passwords do not match').required('Required'),
});
